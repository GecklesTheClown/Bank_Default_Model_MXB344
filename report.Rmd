...
Different variations of stepwise regression were used (both, backward & forward)
...
Using our knowledge from the fixed effects model we can test some fixed effects models.

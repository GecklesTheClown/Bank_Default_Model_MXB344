...
ext_issued_fail <- filter(ext_loan_data, repay_fail == "1")
issuedfailsumext <- count(ext_loan_data_fail, issue_d, .drop = FALSE)

# Obtain proportion and log(proportion) of failure in each issue_d
prop_issue_d <- issuedfailsumext[,2] / issuedsum[,2]

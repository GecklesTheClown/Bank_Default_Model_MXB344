...
One surprising difference found between the two models was the significance of verification_status in our fixed effects model this was significant while in our random effects model it was not. We also found that the interaction term between int_rate:annual_inc was significant in the random effect model and not the fixed effect model

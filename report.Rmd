...
```
```{r}
final_glm_logit <- glm(formula = repay_fail ~
             int_rate + 
             term + 
             emp_length + 
             purpose + 
...
final_glm_probit <- glm(formula = repay_fail ~
             int_rate + 
             term + 
             emp_length + 
             purpose + 
...
roc.glm(final_glm_logit)
roc.glm(final_glm_probit)
...
Both our fixed-effects and mixed effects model perform significantly better in terms of (Gini value) to the model used prior of the acquisition.

...
We then plotted the proportion of failure for our random effects to determine if the proportions differ within each location (address state and zip code) and if the proportions differ with time (issue date of loan and earliest credit line)

Here are the plots

```{r exploreext data set random effects, include=TRUE}
pissuedfail ; pzipcfail ; paddsfail
```
...
```{r exploreext data set issue_date, include=TRUE}

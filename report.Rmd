...
m <- glmer(repay_fail ~ int_rate + term + emp_length + purpose + verification_status + home_ownership + annual_inc +
    (1 |addr_state) + (1|issue_d), data = extended_loan_data, family = binomial, control=glmerControl(optimizer = "bobyqa",optCtrl=list(maxfun=1e6)))
...
auc.perf@y.values
plot_summs(forward_sel_model,m, rescale.distributions = TRUE, exp=TRUE)
```

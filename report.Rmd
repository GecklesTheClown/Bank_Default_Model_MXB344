...
drop<-c("credit_age_yrs",
        ...
        "total_rec_int",
        "total_rec_prncp")
all_loan_data_edit = all_loan_data[,!(names(all_loan_data) %in% drop)]
...
predicted_values_m.pro <- predict(m.full.1w.pro, type = 'response', newdata = training_loan_data)
plot(predicted_values_m.pro)
predicted_values_m.pro_vali <- predict(m.full.1w.pro, type = 'response', newdata = validation_loan_data)
